...
def power(phase: Phase, ac: Aircraft, horizontal_speed, vertical_speed,
          altitude):
    ...
    C_L = C_L_from_lift(ac.total_mass * g * ac.design_load_factor, rho,
                        airspeed, ac.wing.area)
    ...
    match phase:
        ...
        case Phase.VERTICAL_CLIMB:
            ...
            return p_hv * (vertical_speed / (2 * vh) +
                           ((vertical_speed /
                             (2 * vh))**2 + 1)**(0.5))  # from Bradut
