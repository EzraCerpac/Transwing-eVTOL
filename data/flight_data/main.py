...
transition_data['time'] = transition_data['time'] + vertical_climb_data['time'].iloc[-1]
cruise_data['time'] = cruise_data['time'] + transition_data['time'].iloc[-1]
transition2_data['time'] = transition2_data['time'] + cruise_data['time'].iloc[-1]
vertical_descent_data['time'] = vertical_descent_data['time'] + transition2_data['time'].iloc[-1]
...
vertical_descent_data['x'] = vertical_descent_data['x'] + transition2_data['x'].iloc[-1]

mission_data = pd.concat([vertical_climb_data, transition_data, cruise_data, transition2_data, vertical_descent_data])
