...
cessna = asb.Airplane(
    ...
    wings=[
        asb.Wing(name="Wing",
                 ...
                 symmetric=True),
        asb.Wing(name="Horizontal Stabilizer",
                 xsecs=[
                     asb.WingXSec(xyz_le=[0, 0, 0],
                                  chord=ft(3, 8),
                                  airfoil=asb.Airfoil("naca0012"),
                                  twist=-2),
                     asb.WingXSec(xyz_le=[ft(1), ft(10) / 2, 0],
                                  chord=ft(2, 4 + 3 / 8),
                                  airfoil=asb.Airfoil("naca0012"),
                                  twist=-2)
                 ],
                 symmetric=True).translate([ft(13, 3), 0, ft(-2)]),
        asb.Wing(name="Vertical Stabilizer",
                 xsecs=[
                     asb.WingXSec(
                         xyz_le=[ft(-5), 0, 0],
                         chord=ft(8, 8),
    ...
    fuselages=[
        asb.Fuselage(xsecs=[
            ...
            asb.FuselageXSec(
                xyz_c=[ft(3), 0, ft(-0.85)], radius=ft(1.7), shape=4),
            asb.FuselageXSec(xyz_c=[ft(5), 0, ft(0)], radius=ft(2.7), shape=3),
            asb.FuselageXSec(
                xyz_c=[ft(10, 4), 0, ft(0.3)], radius=ft(2.3), shape=3),
