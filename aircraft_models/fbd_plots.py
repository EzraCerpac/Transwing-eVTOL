...
def animate_trans(blacked_out: bool = False, keep_images: bool = False):
    ...
    command = ['ffmpeg', '-i', 'FBDs/frame_%03d.jpeg', '-b:v', '30000k', 'FBDs/black_trans_animation.mp4']
...
if __name__ == '__main__':
    ...
    # plot_trans(trans_wing, 0.1, add_cg_dot=True, add_cg_line=True, add_engine_thrust=True, add_battery=True)
    # plot_trans(trans_wing, 0.3, add_cg_dot=True, add_cg_line=True, add_engine_thrust=True, add_battery=True)
    # plot_trans(trans_wing, 0.7, add_cg_dot=True, add_cg_line=True, add_engine_thrust=True, add_battery=True)
    # plot_trans(trans_wing, 1,   add_cg_dot=True, add_cg_line=True, add_engine_thrust=True, add_battery=True)
